...
public class Materia implements Serializable {
    ...
    /**
     * Método para añadir una unidad temática manteniendo ambos lados de la relación.
     * @param unidad La unidad temática a añadir
     */
    ...
    /**
     * Método para eliminar una unidad temática manteniendo ambos lados de la relación.
     * @param unidad La unidad temática a eliminar
     */
    public void removeUnidadTematica(UnidadTematica unidad) {
        unidadesTematicas.remove(unidad);
        unidad.setMateria(null);
    }
