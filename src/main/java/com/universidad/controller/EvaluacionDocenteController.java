...
public class EvaluacionDocenteController {
    ...
    @GetMapping("/con-evaluaciones")
    public ResponseEntity<List<Docente>> obtenerDocentesConEvaluaciones() {
        List<Docente> docentes = evaluacionDocenteService.obtenerTodosConEvaluaciones();
