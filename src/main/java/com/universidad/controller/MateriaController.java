...
public class MateriaController {
    ...
    public ResponseEntity<List<MateriaDTO>> obtenerTodasConUnidades() {
        List<MateriaDTO> materiasConUnidades = materiaService.obtenerTodasLasMaterias();
        return ResponseEntity.ok(materiasConUnidades);
    }
    ...
    public ResponseEntity<List<UnidadTematicaDTO>> reemplazarUnidades(
            @PathVariable("id") Long materiaId,
            @RequestBody List<UnidadTematicaDTO> nuevasUnidades) {
        List<UnidadTematicaDTO> actualizadas =
                materiaService.reemplazarUnidadesDeMateria(materiaId, nuevasUnidades);
