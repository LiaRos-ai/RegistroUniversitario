...
public class EstudianteController { // Define la clase EstudianteController
    ...
    public ResponseEntity<EstudianteDTO> obtenerEstudiantePorNumeroInscripcion(@PathVariable String numeroInscripcion) { // Método
                                                                                                                         // para
                                                                                                                         // obtener
                                                                                                                         // un
                                                                                                                         // estudiante
     ...
     * public ResponseEntity<List<Materia>>
     * obtenerMateriasDeEstudiante(@PathVariable("id") Long estudianteId) {
     * List<Materia> materias =
     * estudianteService.obtenerMateriasDeEstudiante(estudianteId);
    ...
    public ResponseEntity<EstudianteDTO> crearEstudiante(@RequestBody EstudianteDTO estudianteDTO) { // Método para
                                                                                                     // crear un nuevo
                                                                                                     // estudiante
